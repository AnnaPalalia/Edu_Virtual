...
class Database extends PDO
{
    ...
    public function select($table, $fields = "*", $where = "", $bind = "", $join = "", $select_clause = "")
    {
        if ($fields != "*") {
        ...
        $sql = "SELECT " . $select_clause . $fields . " FROM " . $table;
                    ...
                    if (is_array($relation)) {
                        ...
                        if (isset($relation[0])) {
                            ...
                            if ($alias == '') {
                                ...
                                $internal_relation = explode(".", current($relation));
                                if (is_array($internal_relation) && count($internal_relation) > 1) {
                                    $relation = 'ON `' . $internal_relation[0] . '`.`' . $internal_relation[1] . '` = `' . $alias . '`.`' . key($relation) . '`';
                                } else {
